<?php
	...
	if(!empty($print['tl_category1'])){
		...
		echo "<li><input type='text' value='".$print['tl_category1']."'></input><input type='text' class='nu-timeline-cms-colorPicker'/><div class='nu-timeline-cms-tlFormDeleteCategoryBtn'><a href=''>Slett</a></div></li>";
		}
		...
		echo "<li><input type='text' value='".$print['tl_category2']."'></input><input type='text' class='nu-timeline-cms-colorPicker'/><div class='nu-timeline-cms-tlFormDeleteCategoryBtn'><a href=''>Slett</a></div></li>";
		}
		...
		echo "<li><input type='text' value='".$print['tl_category3']."'></input><input type='text' class='nu-timeline-cms-colorPicker'/><div class='nu-timeline-cms-tlFormDeleteCategoryBtn'><a href=''>Slett</a></div></li>";
		}
		...
		echo "<li><input type='text' value='".$print['tl_category4']."'></input><input type='text' class='nu-timeline-cms-colorPicker'/><div class='nu-timeline-cms-tlFormDeleteCategoryBtn'><a href=''>Slett</a></div></li>";
		}
		...
		echo "<li><input type='text' value='".$print['tl_category5']."'></input><input type='text' class='nu-timeline-cms-colorPicker'/><div class='nu-timeline-cms-tlFormDeleteCategoryBtn'><a href=''>Slett</a></div></li>";
		}
		...
		echo "<li><input type='text' value='".$print['tl_category6']."'></input><input type='text' class='nu-timeline-cms-colorPicker'/><div class='nu-timeline-cms-tlFormDeleteCategoryBtn'><a href=''>Slett</a></div></li>";
		}
	}
	echo "</ul>";
?>