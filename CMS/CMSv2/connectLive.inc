...
<?php
	$connect = mysql_connect("zupe.org.mysql", "zupe_org", "FT3yCux5"); //kobler til server (server, brukernavn, passord)
	if (!$connect) {
...
//	echo '<p style="color: green;">Connected</p>'; //hvis tilkoblingen er OK, skrives Connected ut på skjermen
	mysql_select_db("zupe_org", $connect); //velger database/schema
?>